...
-- Her 10 kayıtta bir risk skorunu güncelle (performans için)
...
BEGIN
  -- Performans için her 10 kayıtta bir çalış
  SELECT COUNT(*) INTO v_total_count
  FROM point_history
  WHERE student_id = NEW.student_id;
  
  -- Her 10 kayıtta bir çalış
  IF v_total_count % 10 != 0 THEN
    RETURN NEW;
  END IF;
...
-- Trigger'ı oluştur (her insert'te çalışır, fonksiyon içinde kontrol yapar)
