-- ÖSYM 2026 TAM SINAV TAKVİMİ - DOĞRU TARİHLER
...
-- OCAK 2026
('e-YDS 2026/1 İngilizce', 'Elektronik Yabancı Dil Sınavı - 1. Dönem (İngilizce)', '2026-01-24 10:00:00+03', 'yds', '#0EA5E9', 'globe', true),
('e-TEP 2026/1 İngilizce', 'Elektronik İngilizce Yeterlik Sınavı (Electronic-Test of English Proficiency)', '2026-01-31 10:00:00+03', 'yds', '#06B6D4', 'globe', true),

-- ŞUBAT 2026
('e-YDS 2026/2 İngilizce', 'Elektronik Yabancı Dil Sınavı - 2. Dönem (İngilizce)', '2026-02-14 10:00:00+03', 'yds', '#0EA5E9', 'globe', true),

-- MART 2026
('MSÜ 2026', 'Millî Savunma Üniversitesi Askerî Öğrenci Aday Belirleme Sınavı', '2026-03-01 10:00:00+03', 'msu', '#1E40AF', 'target', true),
('GUY 2026', 'Gelir İdaresi Başkanlığı Gelir Uzman Yardımcılığı Giriş Sınavı', '2026-03-07 10:00:00+03', 'guy', '#059669', 'briefcase', true),
...
('STS Tıp 2026/1', 'Tıp Doktorluğu Alanında Yurt Dışı Diploma Denkliği Sınavı - 1. Dönem', '2026-03-15 10:00:00+03', 'sts', '#EF4444', 'target', true),
...
('STS Diş Hekimliği 2026/1', 'Diş Hekimliği Alanında Yurt Dışı Diploma Denkliği Sınavı - 1. Dönem', '2026-04-26 10:00:00+03', 'sts', '#F43F5E', 'target', true),
...
('ÖZYES 2026', 'YKS Kapsamında Spor Bilimleri İçin Özel Yetenek Sınavı (15-18 Ağustos)', '2026-08-15 10:00:00+03', 'yks', '#F97316', 'target', true),
...
('STS Tıp 2026/2', 'Tıp Doktorluğu Alanında Yurt Dışı Diploma Denkliği Sınavı - 2. Dönem', '2026-08-23 10:00:00+03', 'sts', '#EF4444', 'target', true),
...
('BKUBTS 2026', 'Tarım ve Orman Bakanlığı Bitki Koruma Ürünleri Bayi ve Toptancılık Sınavı', '2026-10-18 10:00:00+03', 'other', '#65A30D', 'target', true),
...
('STS Diş Hekimliği 2026/2', 'Diş Hekimliği Alanında Yurt Dışı Diploma Denkliği Sınavı - 2. Dönem', '2026-11-01 10:00:00+03', 'sts', '#F43F5E', 'target', true),
...
('STS Eczacılık 2026', 'Eczacılık Alanında Yurt Dışı Diploma Denkliği Sınavı', '2026-11-07 10:00:00+03', 'sts', '#EC4899', 'target', true),
