...
async function main() {
  ...
  if (error) {
    ...
    if (error.code === '42P01') {
      console.log('\n📋 Tablo bulunamadı! Lütfen önce Supabase SQL Editor\'de şu SQL\'i çalıştırın:\n')
      console.log(`
...
CREATE POLICY "turkey_cities_select" ON turkey_cities FOR SELECT USING (true);
  ...
  console.log(`✅ ${turkishCities.length} il başarıyla eklendi!`)
  ...
  console.log(`📊 Veritabanında toplam ${count} il var.`)
}
