...
import { GraduationCap, Mail, Lock, Eye, EyeOff, User, Loader2, Users, UserCheck, Users2 } from 'lucide-react'
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-surface-600 mt-6">
            ...
            <Link href="/giris" className="text-primary-500 font-medium hover:underline">
              Giriş Yap
            </Link>
          </p>
        </div>
